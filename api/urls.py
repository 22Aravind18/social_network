...
from .views import signup_view, login_view, home_view, logout_view, send_friend_request, respond_friend_request,SearchView, list_friends, list_pending_requests
